function [error_Indoor,err2,varargout]=Song_SRWSpeed(Network,X,Y,ErrorName)
...
%%Create new data if have no data in "Network"
if nargin==0
...
for k=1:Network.speedStep
    ...
    for i=1:Network.time
        ...
        %Initial Position Estimation calculate
%         PIni = WiFi_Radar(Network);
        ...
        for j = 1:numOfSeg
            ...
            Network.PIni = PPIni;
            [errmat temp currentToc]=swatiCore_Song(Network);
